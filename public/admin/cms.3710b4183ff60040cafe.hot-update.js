...
function ImageToRight(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "flex flex-col my-10 items-center max-w-screen-lg mx-auto py-5 md:flex-row",
    __self: this,
    __source: {
    ...
    className: "flex-1 my-auto mx-auto w-32",
    src: image,
    alt: title,
    __self: this,
    __source: {
...
//# sourceMappingURL=cms.3710b4183ff60040cafe.hot-update.js.map