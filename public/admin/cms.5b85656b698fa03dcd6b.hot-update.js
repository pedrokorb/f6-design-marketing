...
var MainBanner = function MainBanner(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "relative w-full overflow-hidden flex flex-row justify-center items-center",
    style: {
  ...
  }, "Sua empresa j\xE1 tem uma"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
    className: "text-white text-4xl font-bold my-8",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21,
  ...
  }, "identidade?"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "bg-black py-5 text-primary rounded-full hover:bg-primary hover:text-black",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22,
...
//# sourceMappingURL=cms.5b85656b698fa03dcd6b.hot-update.js.map